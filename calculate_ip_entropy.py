...
if __name__ == '__main__':
    data = FileUtil.read_json_from_file('all_domain_ip_map.json')
    ...
    domain_entropies = FileUtil.read_json_from_file('all_domain_entropies.json')
    ...
    output_file = 'all_ip_entropies.json'
